...
<head>
    ...
    <style>
        ...
        * {
        ...
        .hero {
            height: 100vh;
            background: linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url('../spa-website/photos/main-img.jpg') no-repeat center center/cover;
            display: flex;
            align-items: center;
            text-align: center;
            color: var(--white);
        ...
        /* Stats Section */
        .stats {
            background: linear-gradient(rgba(139, 115, 85, 0.9), rgba(139, 115, 85, 0.9)), url('') no-repeat center center/cover;
            color: var(--white);
            text-align: center;
        }
        ...
        /* ========== ABOUT PAGE STYLES ========== */
        .about-header {
            background: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url('https://images.unsplash.com/photo-1540555700478-4be289fbecef?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80') no-repeat center center/cover;
            height: 400px;
            display: flex;
            align-items: center;
            text-align: center;
        ...
        .services-header {
            background: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url('https://images.unsplash.com/photo-1544161515-4ab6ce6db874?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80') no-repeat center center/cover;
            height: 400px;
            display: flex;
            align-items: center;
            text-align: center;
        ...
        .packages-header {
            background: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url('https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2120&q=80') no-repeat center center/cover;
            height: 400px;
            display: flex;
            align-items: center;
            text-align: center;
        ...
        /* ========== BLOG PAGE STYLES ========== */
        .blog-header {
            background: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), url('https://images.unsplash.com/photo-1506905925346-21bda4d32df4?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80') no-repeat center center/cover;
            height: 400px;
            display: flex;
            align-items: center;
            text-align: center;
        ...
        @media (max-width: 992px) {
            .service-detail-content, .contact-content {
        ...
        @media (max-width: 768px) {
            ...
            .services-header h1, .about-header h1, .packages-header h1, .blog-header h1 {
                font-size: 2.2rem;
            }
            ...
            /* Mobile responsive user profile - hide name, show only avatar */
            .user-name-desktop {
        ...
        @media (max-width: 576px) {
            ...
            .services-header, .about-header, .packages-header, .blog-header {
                height: 300px;
                margin-top: 70px;
            }
            ...
            .service-categories, .packages-grid, .blog-grid {
                grid-template-columns: 1fr;
            }
            
            .service-card, .blog-card, .package-card {
                margin-bottom: 20px;
            }
        ...
        @media (max-width: 400px) {
            ...
            .service-content, .blog-content, .package-body {
                padding: 20px;
            }
        }
    </style>
